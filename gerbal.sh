...
uptime
sleep 1
g3 "should the Gerbal do more? or is this all you needed?"
ConfirmOrExit
...
apt-get update
sleep 3
g4 "running upgrades to server systems from deb packages"
sleep 2
apt-get upgrade -y
sleep 3
g4 "running aptitude for checksum"
sleep 2
aptitude update
sleep 3
g4 "updating packages on aptitued recomendation"
aptitude upgrade -y
sleep 4
ConfirmOrExit
